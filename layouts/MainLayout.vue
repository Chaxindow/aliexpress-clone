      ...
      <ul class="flex
        ...
        <li @mouseenter="isHelpMenu = true" @mouseleave="isHelpMenu = false"
          ...
          <div div id="HelpMenu" v-if="isHelpMenu"
            ...
            <div class="text-semibold text-[12px] py-3 px-1 hover:bg-gray-200">
              Yardim merkezi
            </div>
            <div class="text-semibold text-[12px] py-3 px-1 hover:bg-gray-200">
              Bir şikayet girin
                ...
                <NuxtLink to="`/item/1`"
                  ...
                  <div class="flex items-center">
                    <img class="rounded-md" width="40"
                      src="https://fastly.picsum.photos/id/144/200/200.jpg?hmac=3uevqKoBuYGJxqInvMh1R9bfnV2bz-Vetuv5Zwnb3mE">
