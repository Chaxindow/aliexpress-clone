        ...
        <div class="max-w-[1200px] mx-auto px-4">
            ...
            <div class="md:flex gap-4 justify-between w-full">
                <div class="md:w-[50%] pt-4">
                    ...
                    <div class="text-[#999999] text-sm">Yardım Merkezi, Disputes & Reports, Buyer Protection, Fikri Mülkiyet Hakkı İhlali Bildir, Regulated Information, Integrity Compliance</div>
